# Pluyus Bitcoin Brute Forcer

A Bitcoin wallet collider that brute forces random wallet addresses

# Like This Project? Give It A Star

[![](https://github.com/dmitriy0342/Pluyus)
...
```
$ git clone https://github.com/dmitriy0342/Pluyus.git pluyus

$ cd pluyus && pip3 install -r requirements.txt
```
...
<a href="https://github.com/dmitriy0342/Pluyus>Create an issue</a> so I can add more stuff to improve
